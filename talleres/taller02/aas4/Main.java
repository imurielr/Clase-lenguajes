public class Main {
	...
	if (raiz == null) {
	    ...
	    Unario unario = (Unario) raiz;
	    switch(unario.obtOper()){
	    case SUMA:
		ret = evaluar(unario.obtHijo());
		break;
	    case RESTA:
		ret = ret - evaluar(unario.obtHijo());
		break;
	    }
        }
	...
	if (raiz == null) {
	    ...
	    Unario unario = (Unario) raiz;
	    sb.append(imprimir(unario.obtHijo())
	      .append(unario.obtOper().toString()));
        }
